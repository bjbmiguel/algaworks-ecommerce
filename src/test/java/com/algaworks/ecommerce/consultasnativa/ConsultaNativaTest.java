...
public class ConsultaNativaTest extends EntityManagerTest {
    ...
    public void usarAquivoXML() {
        Query query = entityManager.createNamedQuery("ecm_categoria.listar"); //ecm_categoria.listar
    ...
    @Test
    public void executarSQLRetornandoEntidade2() {
    ...
    @Test
    public void executarSQLRetornandoEntidade3() {
